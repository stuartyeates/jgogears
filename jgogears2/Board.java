...
/**
 * A Board represents a particular state of the board at a particular point in time.
 * 
 * It doesn't store complete game state, since some Ko rules traverse all previous board states.
 * 
